...
os.environ["CUDA_VISIBLE_DEVICES"] = "0" #启用主GPU
...
def tra_continue():
    ...
    if RESUME:
        path_checkpoint='model_best_checkpoint_resnet50.pth.tar'
...
if __name__ == "__main__":
    ...
    batch_size = 48
    #64:torch.cuda.OutOfMemoryError: CUDA out of memory.
    #16: Couldn't open shared file mapping: <000001AD430778D2>, error code: <1455>
    ...
    # ------------------------------------ step 2/4 : 定义网络 ------------------------------------
    #model = models.resnet50(pretrained=True)#weights=torchvision.models.ResNet18_Weights.IMAGENET1K_V1
    ...
    if os.path.exists('model_best_checkpoint_resnet50.pth.tar'):
        tra_continue()
